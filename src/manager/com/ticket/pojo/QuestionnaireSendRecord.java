...
/**
 * 问卷发放记录表
 * @ClassName: QuestionnaireSendRecord   
 * @Description: 问卷发放记录
 * @author HiSay  
 ...
 */
@Entity
@Table(name="ticket_QuestionnaireSendRecord",uniqueConstraints={@UniqueConstraint(columnNames = {"id"})})
public class QuestionnaireSendRecord implements Serializable {
