...
/**
 * 管理员操作日志
 * @ClassName: SystemUserOperation   
 * @Description: 系统管理员操作记录
 * @author HiSay  
 * @date  2014-10-15 13:12:06
 *
 */
@Entity
@Table(name="ticket_SystemUserOperation",uniqueConstraints={@UniqueConstraint(columnNames = {"id"})})
public class SystemUserOperation extends BasePojo implements Serializable {
