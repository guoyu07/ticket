...
var imageUrl = '/common/iColorPicker/color.png';
...
this.iColorPicker = function() {
    jQuery("input.iColorPicker").each(function(i) {
        ...
        jQuery(this).css("backgroundColor", jQuery(this).val()).after('<a style="float:left;" href="javascript:void(null)" id="icp_' + this.id + '" onclick="iColorShow(\'' + this.id + '\',\'icp_' + this.id + '\')"><img src="' + imageUrl + '" style="border:0;margin:0 0 0 3px" align="absmiddle" ></a>')
    })
};
jQuery(function() {
    iColorPicker()
