	...
	<body class="mobile">
		<div class="mobile-view">
			<div class="mobile-page">
						...
						<span class='select_tit inline_block'
							...
							<div class="button-group fz36">
								...
								<ul class="drop-menu changeLuggageState">
									<li href="/airport_transferLuggage.action?luggageState=yes">
										有托运行李
									</li>
									<li href="#">
										无托运行李
				...
				<!-- <a href="/airport/hangbanchaxun.ticket?flag=true"><i class="icon-caret-down"></i>查询航班获取旅程助手</a> -->
