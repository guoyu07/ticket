...
<script type="text/javascript"
	src="/template/wap/js/employeeCRM/electroMobileyanzheng.js"></script>
		...
		<s:if test="#session.fromApp == null && #parameters.fromApp == null">
			...
			<div class="mobile-main">
				...
				<div class="tit_tab" style="padding-top: 0px;">
					<a href="javascript:void(0);" class="c_white" class="block"
						id="snap">开始扫描</a>
				</div>
				<div class="tit_tab">
					<a href="/wapValidation_manageElectromobile.action"
