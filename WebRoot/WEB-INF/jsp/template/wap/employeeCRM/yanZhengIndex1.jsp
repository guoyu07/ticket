		...
		<div class="mobile-view">
			...
			<s:if test="#session.fromApp == null && #parameters.fromApp == null">
				...
				<div class="mobile-main">
					<div class="tit_tab">
						<select id="hall" name="hall" class="my_input" datatype="*">
						...
						<a href="/wapValidation_yanZhengErWeiMaIndex1.action">扫二维码验证</a>
					...
					<div class="tit b_blue" style="padding-top: 0px;">
						<a href="javascript:yanzhengbjdj();" class="c_white" class="block">确定</a>
					</div>
					<div class="tit_tab">
						<a href="/wapValidation_manage.action" class="b_yello c_grey">验证记录</a>
