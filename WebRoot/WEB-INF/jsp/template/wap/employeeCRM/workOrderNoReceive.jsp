		...
		<div class="mobile-view">
		    ...
		    <s:if test="#session.fromApp == null && #parameters.fromApp == null">
		        ...
		        <div class="mobile-main">
		            <div class="text-center fz40 padding-large-top">未接工单</div>
		            <div class="text-center fz40 padding-large-top">
		            	...
		            	<a href="javascript:ing();" class="batchRealDeleteBtn" value="${actionName}CheckBox" entityName="${entityName}">批量接单</a>
		            </div>
		           <s:iterator value="list" var="l">
		            <div class="line mr40">
		           	<div class="x1">
		                ...
		                <div class="x1"></div>
		                <div class="x3">
		                	<a href="employeeCRM_detailsNoReceivePage.action?id=${l.id }">
