	...
	<body class="mobile">
		<div class="mobile-view">
		    ...
		    <s:if test="#session.fromApp == null && #parameters.fromApp == null">
		        ...
		        <div class="mobile-main">
		            <%-- <div class="mr40 work_ls clearfix margin-large-bottom">
	            	<s:if test="#dispatch.validation.type == @com.ticket.enumer.BjdjOrderType@bjdj">
		                <div class="txt_large fz24">办票<br>服务</div>
		                <div class="arrow_right_black"></div>
		                <div class="txt_large fz24">安检<br>通道</div>
		                <div class="arrow_right_black"></div>
		                <div class="txt_large fz24">电瓶车<br>服务</div>
		                <div class="arrow_right_black"></div>
		                <div class="txt_large fz24">送达登<br>机口</div>
	                </s:if>
	                <s:else>
		                <div class="txt_large fz24">电瓶车<br>服务</div>
	                </s:else>
		            ...
		            <div class="mr40">
		                <dl class='fz20'>
		                    <dd class='clearfix height-big border-bottom padding-big-bottom margin-big-bottom'>
		                        <label class='fz18'><em>航班号：</em>
		                        <span class='c_l_grey'>${dispatch.validation.appointment.flightNo }</span></label>
		                    </dd>
		                    <dd class='clearfix height-big border-bottom padding-big-bottom margin-big-bottom'>
		            ...
		            <div class="mr40">
						<button class="button d_button b_grey_1 c_yello block verificate" value="${id }">核销</button>
					</div>
		            <div class="tit_tab">
		...
		<div class="dialog" style="display:none;">
		    <div class="question_dialog box_dialog">
		        <div class="c_content b_white">
		            <h2 class="fz30 c_black padding-big-bottom">问题反馈</h2>
	                <input id="feedback" name="feedback" style="height:200px;" multiple="multiple"/>
		            <button type="button" class="button bg-yello fz26 padding-big margin-large-top no">提交</button>
		        </div>
		    </div>
		    <div class="confirm_dialog box_dialog">
		        <div class="c_content b_white text-center">
		            <h2 class="fz30 c_black">确认核销？</h2>
		            <button type="button" class="button bg-yello fz26 padding-big margin-large-top yes" >是</button>
		            <button type="button" class="button bg-yello fz26 padding-big margin-large-top no">否</button>
		        </div>
		    </div>
		</div>
		 -->
