				...
				<div class="mobile-main">
					<div class="tit_tab">
						<a href="/wapValidation_manage.action"
							class='b_white c_grey border'>便捷登机</a>
						<a href="javascript:void(0);">电瓶车服务</a>
					</div>
					<div>
							<div class="searchForm">
								<label class='button'>
									<i class='icon-search c_l_grey'></i>
									<input type="text" name="" value="" placeholder='服务码'
										id="fuwuma">
								</label>
								<button class="button bg-yello" id="shous">
									搜索
								</button>
							</div>
					</div>
									...
									<tr>
										...
										<td class="fz20">
											<s:if test="!dispatchService.isDispatch(#c.id)">
												<a
													href="/wapBjdjDispatch_manageForElectromobile.action"
