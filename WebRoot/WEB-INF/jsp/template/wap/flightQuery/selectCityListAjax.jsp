...
<%@ taglib prefix="s" uri="/struts-tags"%>
	<s:if test="flag=='domesticAirportThreeCode'">
...
<s:elseif test="flag=='InternationalAirportThreeCode'">
	...
	<s:if test="#request.intHotAirportList != null">
		<s:iterator id="intHotAirport" value="#request.intHotAirportList">
			<dd class='fz22 margin-big border-bottom padding-big-bottom' value="${intHotAirport.threeCode }">${intHotAirport.name }（${intHotAirport.threeCode  }）<p class='fz14'>${intHotAirport.englishName }</p></dd>
		</s:iterator>
	</s:if>
	<dt class='fz22 b_l_grey padding-big margin-large-top' id='A'>A</dt>
