					...
					<div id="SDContent">
						<div class="c_img text-center mr40">
							...
							<map name="m_pic" id="m_pic">
								<area shape="rect" coords="180,465,341,604" href="<ticket:common type="positionUrl" value="dengjikou_chufa_guonei"/>"
									alt="" />
								<area shape="rect" coords="180,317,341,450" href="<ticket:common type="positionUrl" value="anjian_chufa_guonei"/>"
									alt="" />
								<area shape="rect" coords="180,165,341,302" href="<ticket:common type="positionUrl" value="xinglituoyun_chufa_guonei"/>"
									alt="" />
								<area shape="rect" coords="180,9,341,152" href="<ticket:common type="positionUrl" value="chufadating"/>"
									alt="" />
							</map>
						</div>
					</div>
