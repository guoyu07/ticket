...
<html>
	...
	<script type="text/javascript">
		...
		var url = $("#url").val();
		function qqLogin(){
			JM.goUrl("/IndexServlet.do?wap=true&bjdj=true");
		}
		function weibologin(){
			JM.goUrl("/memberWeiBo_weiBoLogin.action?wap=true&bjdj=true");
		}
	</script>
                    ...
                    <div class="main_body">
    					...
    					<form action="/${actionName }_login.action" id="memberForm" name="memberForm" alertConfirm="false">
    						...
    						<button class='button bg-yello d_button block margin-big-top' id="submitBtn">
   					    	...
   					    	<a id="manageLink" href="bjdjOrderTemplate_confirmPage.action"></a>
