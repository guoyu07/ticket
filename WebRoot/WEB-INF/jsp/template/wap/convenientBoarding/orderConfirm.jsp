				...
				<div class="mobile-main">
					<div class="order_form">
						<form action="/${actionName}_generateOrder.action" method="post" id="memberForm">
							<a id="manageLink" href="/${actionName}_payPage.action" sytle="display: none;"></a>
							...
							<div class="line clearfix mrlr40">
		                        <p style="margin-left: 0px;">
		                        	...
		                        	<a href="/airport/1445940941512.ticket" class='c_red'>《使用条款》</a>
							...
							<div>
                                <p>
    								...
    								<label for="loginBuy" style="padding: 0; border: 0;">
    									<input type="radio" value="login" id="loginBuy" name="purchaseType" onclick="location.href='bjdjMember.action'">登陆购买
    								</label>
                                </p>
							</div>
							</s:if>
