		    ...
		    <div class="mobile-page">
		        <s:if test="#session.fromApp == null && #parameters.fromApp == null">
					<div class="mobile-top">
						<div class="header">
							...
							<span class="FR">
								<i class="memberFavorite" title="便捷登机" url="bjdj_indexAjax.action?bjdjPage_id=${bjdjPage_id }">收藏</i>
		        ...
		        <div class="mobile-main" style='padding:0px;'>
		            ...
		            <div class="quick_icons clearfix">
		                <a href="/airport/${serviceProfile }.ticket?bjdjPage_id=${bjdjPage_id }" class="fz30"><i></i><p>便捷登机介绍</p></a>
		                <a href="/airport/${serviceFlow }.ticket?bjdjPage_id=${bjdjPage_id }" class="fz30"><i></i><p>服务流程</p></a>
		                <a href="/airport/${useSerms }.ticket" class="fz30"><i></i><p>使用条款</p></a>
		                <a href="tel:${service_phone}" class="fz30"><i></i><p>咨询电话</p></a>
		                <a href="bjdjCommentTemplate_listPage.action?bjdjPage_id=${bjdjPage_id }" class="fz30"><i></i><p>查看评价</p></a>
		            ...
		            <div class="home_btn">
		            	<s:if test="#session.sessionMember != null">
		            		<s:if test="#session.sessionMember.memberType != null">
		            			...
		            			<s:else>
				            		<a href="bjdjOrderTemplate_confirmPageAjax.action?versionFlag=site&bjdjPage_id=${bjdjPage_id }" class='h_buy'><i></i>立即购买</a>
				            	</s:else>
		            		</s:if>
		            		<s:else>
			            		<a href="bjdjOrderTemplate_confirmPageAjax.action?versionFlag=site&bjdjPage_id=${bjdjPage_id }" class='h_buy'><i></i>立即购买</a>
