		...
		<div class="mobile-view">
		    <div class="mobile-page">
		        <jsp:include page="../common/title.jsp">
		        	<jsp:param value="我要反馈" name="title"/>
		        </jsp:include>
		        <div class="mobile-main">
		        	<form action="feedBack_feedBack.action" method="post" id="memberForm">
		        		<a href="feedBack_myFeedBack.action" id="manageLink" style="display: none;"></a>
			            <div class="mr40">
						    <input name="phone" type="text" class="input d_input b_grey fz22 margin-large-top" style="height:70px;line-height:40px;" placeholder="请输入手机号" dataType="m"/>
