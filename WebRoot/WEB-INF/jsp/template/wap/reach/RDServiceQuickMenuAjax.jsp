...
<div class="line text-center">
	<ticket:common type="flightQuickMenuList" value="${memberSelfMenuId }&l" size="8"/>
	...
	<c:forEach begin="${count }" end="7" step="1">
		<div class="x3">
			<a href="#" class='custom_menu_btn serviceQuickMenuBtn' flightQuickMenu="${memberSelfMenuId }" menuCount="${defaultCount }" defaultPosition="l"></a>
		</div>
	</c:forEach>
</div>
