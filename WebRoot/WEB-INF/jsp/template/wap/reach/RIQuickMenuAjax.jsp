...
<div class="line text-center">
	...
	<s:if test="#session.sessionMember == null">
		<ticket:common type="visiorMenuList" value="f"/>
		...
		<s:if test="#request.defaultList != null">
			<s:iterator id="default" value="#request.defaultList">
				<div class="x3">
					<a href="#" class='custom_menu_btn toSetQuickMenu' defaultPosition="f"></a>
				</div>
			</s:iterator>
		</s:if>
	</s:if>
	<s:else>
		<!-- 会员自定义菜单 -->
		<ticket:common type="memberMenuList" value="f"/>
		...
		<ticket:common type="memberNoSetQuickMenuList" value="f"/>
