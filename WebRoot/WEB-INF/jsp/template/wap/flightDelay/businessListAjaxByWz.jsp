...
<ticket:common type="businessListByWz" value="${id}"/>
<ul>
<s:if test="#request.businessListByWz != null">
	<s:iterator	id="businessInfo" value="#request.businessListByWz" status="st">
		<li>
