...
<script type="text/javascript" src="/template/pc/js/serviceCodeDelay.js"></script>
...
<body>
	...
	<div class="w980">
		...
		<div class="cfzz hh">
			...
			<h1 class='b_l_grey padding margin-large-bottom fz26'>选择延期时长</h1>
			<form action="pcOrder_serviceCodeDelay.action" method="post" id="memberForm2">
					...
					<tr>
						<td height="200">
							<ul>
								...
								<li><small>
								<input name="delayRule" value="${dr.id }" type="radio" <s:if test="#st.count == 1">checked="checked"</s:if>/>
								</small>${dr.delayTime }天${dr.record }积分</li>
								</s:iterator>
							</ul>
						</td>
					</tr>
					<tr>
						<td height="40"><input type="image" src="images/YQ.gif" class="button d_button block b_blue c_white" />
						<a href="pcOrder_allOrder.action" id="manageLink" style="display: none;"></a>
						</td>
					</tr>
				</table>
				</form>
