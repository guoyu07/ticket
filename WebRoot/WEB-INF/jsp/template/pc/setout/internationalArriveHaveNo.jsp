...
<script type="text/javascript">
	...
	function hava(){
		...
		JM.goUrl("pcMembers_internationalArriveHave.action");
		}
	}
</script>
...
<body>
    ...
    <div class="cfzz hh">
        <div class="two_tabs clearfix">
            <a href="/pcMembers_domesticArriveHaveNo.action" >国内出发</a>
            <a href="javascript:void(0);" class="selected">国际出发</a>
        </div>
        <div class="con_box">
            <div class="con_checkobx">
                <p><input type="checkbox" name="" value="">已在线值机</p>
                <p><input type="checkbox" name="" value="" id="hava">需要托运行李</p>
            </div>
            <div class="c_img text-center mr40">
                <img src="/template/pc/images/area/pic15.png" width="493" height="624" usemap="#m_pic" alt="" />
