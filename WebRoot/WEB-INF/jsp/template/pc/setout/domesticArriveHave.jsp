...
<script type="text/javascript">
	...
	function hava(){
		...
		JM.goUrl("pcMembers_domesticArriveHaveNo.action");
		}
	}
</script>
...
<body>
    ...
    <div class="cfzz hh">
        <div class="two_tabs clearfix">
            <a href="javascript:void(0);" class="selected">国内出发</a>
            <a href="/pcMembers_internationalArriveHave.action">国际出发</a>
        </div>
        <div class="con_box">
            <div class="con_checkobx">
                <p><input type="checkbox" name="" value="">已在线值机</p>
                <p><input type="checkbox" name="hava" value="" id="hava" checked="checked">需要托运行李</p>
            </div>
            <div class="c_img text-center mr40">
                <img src="/template/pc/images/area/pic12.png" width="496" height="612" usemap="#m_pic" alt="" />
