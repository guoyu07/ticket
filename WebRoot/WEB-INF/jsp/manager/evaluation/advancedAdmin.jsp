				...
				<div id="viewbox" class="site_right_box">
					<table class="my_table100 margin_top10">
					    ...
					    <tr  class="text_align_left">
					      <td><span>
				    		<a href="#" class="batchSendbackBtn" entityName="${entityName}" value="${c.id }">批量发回</a>
					      </span></td>
					    </tr>
					    <tr>
					      <td>
									...
									<s:iterator var="c" value="pageModule.pageList" status="st">
								  		<tr>
										    ...
										    <td>
										    	...
										    	<a href="#" class="sendbackBtn" entityName="${entityName}" value="${c.id }">发回</a>
										    	</s:if>
										    	<%-- <s:if test="evaluationService.canFeedbackDepartment(#c.id)">
										    	<a href="#" class="feedbackDepartmentBtn" entityName="${entityName}" value="${c.id }">回复部门</a>
										    	</s:if> --%>
										    </td>
										</tr>
								  	</s:iterator>
