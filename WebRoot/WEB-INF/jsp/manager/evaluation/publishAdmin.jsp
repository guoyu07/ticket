				...
				<div id="viewbox" class="site_right_box">
					<table class="my_table100 margin_top10">
					    ...
					    <tr  class="text_align_left">
					      <td><span>
					      	<s:if test="operationFlag == 'published'">
					      	<a href="#" class="batchUnpublishBtn" value="${actionName}CheckBox" entityName="${entityName}">批量取消发布</a>
					      	</s:if>
					      	<s:else>
					      	<a href="#" class="batchPublishBtn" value="${actionName}CheckBox" entityName="${entityName}">批量发布首页</a>
					      	</s:else>
					      </span></td>
					    </tr>
					    <tr>
					      <td>
								<table class="my_table100">
								  <tr class="my_table_top1">
								    ...
								    <td width="80" class="text_align_center">编号</td>
								    <td width="20" class="text_align_center">用户</td>
								  ...
								  <s:if test="pageModule != null && pageModule.totalCount > 0">
									<s:iterator var="c" value="pageModule.pageList" status="st">
								  		<tr>
										    ...
										    <td>
										    	<s:if test="operationFlag == 'published'">
										    	<a href="#" class="unpublishBtn" entityName="${entityName}" value="${c.id }">取消发布</a>
										    	</s:if>
										    	<s:else>
										    	<a href="#" class="publishBtn" entityName="${entityName}" value="${c.id }">发布首页</a>
										    	</s:else>
										    </td>
										</tr>
								  	</s:iterator>
