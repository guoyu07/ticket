					...
					<form action="/${actionName}_add.action" id="commonForm"
						...
						<table class="my_table100 margin_top10">
							...
							<tr>
								...
								<td>
									<select name="type" id="type" class="my_select" datatype="*" >
							...
							<tr>
								...
								<td>
									<select name="isSinglePage" id="isSinglePage" class="my_select" datatype="*" >
							...
							<tr>
								...
								<td>
									<input id="directory" name="directory" class="my_input" datatype="*" />
							...
							<tr>
								...
								<td>
									<input id="toPageAjax" name="toPageAjax" class="my_input" datatype="*" ignore="ignore" />
