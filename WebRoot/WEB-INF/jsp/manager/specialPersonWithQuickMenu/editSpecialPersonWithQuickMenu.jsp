					...
					<form action="/${actionName}_edit.action" id="commonForm" name="commonForm">
						...
						<table class="my_table100 margin_top10">
							<tr>
								...
								<td>
									<select id="personType" name="personType" class="my_select" currentValue="${specialPersonWithQuickMenu.personType}" datatype="*">
							...
							<tr>
								...
								<td>
									<select id="quickMenu_id" name="quickMenu_id" class="my_select" currentValue="${specialPersonWithQuickMenu.quickMenu_id}" datatype="*">
