					...
					<form action="/${actionName}_edit.action" id="commonForm"
						...
						<table class="my_table100 margin_top10">
							...
							<tr>
								...
								<td>
									<select value="${systemUser.sex }" name="sex" id="sex"
							...
							<tr>
								...
								<td>
									<input id="loginId" name="loginId" class="my_input"
										datatype="*" value="${systemUser.loginId}" />
									<p class="Validform_checktip" style="display: inline;">
										请填写登陆名称
									</p>
								</td>
							...
							<tr>
								...
								<td>
									<input id="password" name="password" class="my_input"
										datatype="s6-20" value="${systemUser.password}"
										type="password" />
									<p class="Validform_checktip" style="display: inline;">
										请填写登陆密码
									</p>
							...
							<tr>
								...
								<td>
									<input id="phone" name="phone" class="my_input" datatype="m" value="${systemUser.phone }"/>
