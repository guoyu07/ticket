				...
				<div id="viewbox" class="site_right_box">
					<table class="my_table100 margin_top10">
					    ...
					    <tr  class="text_align_left">
					      <td><span>
					      	<a href="/surveyOption_add.action?surveyQuestionId=${surveyQuestionId }&versionFlag=${versionFlag}">新增选项</a>
								  ...
								  <s:if test="pageModule != null && pageModule.totalCount > 0">
								  	<s:iterator id="c" value="pageModule.pageList" status="st">
								  		<tr>
										    ...
										    <td>${c.title }</td>
										    <td>
										     <ticket:systemCommon type="surveyQuestionObj" value="${c.surveyQuestionId }"/>
									    		 ${surveyQuestionObj.title }
										    </td>
										    <td><span>
