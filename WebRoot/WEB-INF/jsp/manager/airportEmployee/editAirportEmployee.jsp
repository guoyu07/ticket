							...
							<tr>
								...
								<td>
									<input id="parent_id" class="easyui-combotree my_input" 
										...
										name="department_id" value="${airportEmployee.department_id}">
								</td>
							</tr>
							<tr>
								<td class="text_align_right" width="150">
								...
								<td>
									<select name="hall_id">
										<s:if test="#halls != null">
											<option value="" ${airportEmployee.hall == null ? 'selected="selected"' : null }>所有大厅</option>
											<s:iterator value="#halls" var="hall">
												<option value="${hall.id }" ${airportEmployee.hall.id == hall.id ? 'selected="selected"' : null }>${hall.number }</option>
											</s:iterator>
										</s:if>
									</select>
							...
							<tr>
								...
								<td>
									<input id="employeeId" name="employeeId" class="my_input"
									       value="${airportEmployee.employeeId}"/>
							...
							<tr>
								...
								<td>
									<input id="password" name="password" type="password" class="my_input" datatype="*"
									       value="${airportEmployee.password}"/>
