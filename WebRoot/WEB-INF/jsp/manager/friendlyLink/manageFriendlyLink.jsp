					...
					<table class="my_table100 margin_top10">
					    ...
					    <tr  class="text_align_left">
					      <td><span>
					      	...
					      	<a href="/${actionName}_add.action?businessInfo_id=${c.businessInfo_id }&versionFlag=${versionFlag}">新增友情链接</a>
							  ...
							  <s:if test="pageModule != null && pageModule.totalCount > 0">
							  	<s:iterator id="c" value="pageModule.pageList" status="st">
							  		<tr>
									    ...
									    <td>
											<ticket:systemCommon type="businessInfoObj" value="${c.businessInfo_id}"/>
