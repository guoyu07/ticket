					...
					<form action="/${actionName}_add.action" id="commonForm" name="commonForm">
						...
						<table class="my_table100 margin_top10">
									<tr>
										...
										<td>
											<input id="startTime" onclick="WdatePicker({dateFmt:'HH:mm:ss'});" name="startTime" class="my_input" datatype="*"/>
									...
									<tr>
										...
										<td>
											<input id="endTime" name="endTime" onclick="WdatePicker({dateFmt:'HH:mm:ss'});" class="my_input" datatype="*"/>
									...
									<tr>
										...
										<td>
											<input id="orderValue" name="orderValue" class="my_input" datatype="*" value="0"/>
