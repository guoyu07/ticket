			...
			<div class="site_right">
				...
				<div id="viewbox" class="site_right_box">
					...
					<form action="/${actionName}_edit.action" id="commonForm" name="commonForm">
						...
						<input type="hidden" name="id" id="id" value="${frontMenu.id}" />
						<table class="my_table100 margin_top10">
							<tr>
								...
								<td>
									<input id="parent_id" class="easyui-combotree my_input" 
										...
										name="parent_id" value="${frontMenu.parent.id}">
							...
							<tr>
								...
								<td>
									<select name="loadSub" class="my_input" datatype="*" value="${frontMenu.loadSub}">
										<option value="false" <s:if test="!frontMenu.loadSub">selected="selected"</s:if>>不显示</option>
										<option value="true" <s:if test="frontMenu.loadSub">selected="selected"</s:if>>显示</option>
									</select>
							...
							<tr>
								...
								<td>
									...
									value="${frontMenu.status.orderValue}"  ignore="ignore"/>
							...
							<tr>
								...
								<td>
									<textarea name="description" class="my_input">${frontMenu.description}</textarea>
