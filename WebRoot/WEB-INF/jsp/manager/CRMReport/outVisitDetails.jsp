					      ...
					      <td>
							<table id="table" class="my_table100">
							  <tr class="my_table_top1">
							    <td width="100">出访人</td>
							    <td width="100">陪同人</td>
							    <td width="100">拜访日期</td>
							    <td width="100">客户账号</td>
							    <td width="100">公司名称</td>
							    <td width="100">联系人</td>
							    <td width="100">联系电话</td>
							    <td width="100">拜访目的</td>
							    <td width="100">出发时间</td>
							    <td width="100">返回时间</td>
							    <td width="100">拜访结果</td>
							  </tr>
							  <s:if test="pageModule != null && pageModule.totalCount > 0">
							  	<s:iterator id="c" value="pageModule.pageList" status="st">
							  		<tr>
									    ...
									    <td>${c.visitPurpose }</td>
									    <td><s:date name="#c.setoutTime" format="yyyy-MM-dd"/></td>
									    <td><s:date name="#c.backTime" format="yyyy-MM-dd"/></td>
									    <td>${c.visitResult }</td>
									 </tr>
							  	</s:iterator>
							  </s:if>
