									...
									<tr>
										...
										<td>
											<input id="studentCard" name="studentCard" class="my_input" datatype="*"
											       value="${commonTraveller.studentCard}"/>
									...
									<tr>
										...
										<td>
											<input id="memberId" name="memberId" class="my_input" datatype="*"
											       value="${commonTraveller.memberId}"/>
