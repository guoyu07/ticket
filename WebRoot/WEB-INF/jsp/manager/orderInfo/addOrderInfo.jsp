					...
					<form action="/${actionName}_add.action" id="commonForm" name="commonForm">
						...
						<table class="my_table100 margin_top10">
									...
									<tr>
										...
										<td>
											<input id="payTime" name="payTime"  onclick="new WdatePicker();" class="my_input" datatype="*"/>
									...
									<tr>
										...
										<td>
											<input id="paidAmount" name="paidAmount" class="my_input" datatype="n"/>
									...
									<tr>
										...
										<td>
											<input id="discountAmount" name="discountAmount" class="my_input" datatype="n"/>
									...
									<tr>
										...
										<td>
											<input id="useIntegral" name="useIntegral" class="my_input" datatype="n"/>
