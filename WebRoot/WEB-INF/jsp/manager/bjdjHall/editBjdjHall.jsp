...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript" src="/manager/js/bjdjHall.js"></script>
	<body>
		<div class="site_warp">
									...
									<tr>
										...
										<td>
											<input id="number" name="number" class="my_input" datatype="*"
											       value="${bjdjHall.number}"/>
											<p class="Validform_checktip" style="display:inline;"> 请填写厅号</p>       
										</td>
									</tr>
									<tr>
										<td class="text_align_right" width="150">
										...
										<td>
											<input id="capacity" name="capacity" class="my_input" datatype="n"
											       value="${bjdjHall.capacity}"/>
											<p class="Validform_checktip" style="display:inline;"> 请填写容量（最大人数）</p>       
										</td>
									</tr>
									<tr>
										<td class="text_align_right" width="150">
										...
										<td>
											<textarea name="description" class="my_input" datatype="*" >${bjdjHall.description}</textarea>
