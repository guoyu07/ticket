					...
					<form action="/${actionName}_edit.action" id="commonForm" name="commonForm">
						...
						<table class="my_table100 margin_top10">
							...
							<tr>
								...
								<td>
									<textarea id="introduce" name="introduce" class="my_input">${departmentInfo.introduce }</textarea>
									<p class="Validform_checktip" style="display:inline;"> 请填写部门介绍</p>       
								</td>
							</tr>
						</table>
