	...
	<script type="text/javascript">
		$(function(){
			...
			$("input[type=radio]").bind("click", function(){
                  ...
                  var dataAuthoritys_id = $(this).attr("privilegeid");
                  ...
                  if($(this).prop("checked")){
                	  $.ajax({
                			type:'POST',
                			dataType:'text',
                			url:'positionDataAuthority_add.action',
                			data:'position_id='+position_id+'&systemModuleId='+systemModuleId+'&dataAuthoritys_id='+dataAuthoritys_id+'&random='+JM.randomNumber,
                 ...
                 /*  else{
                	  $.ajax({
                			type:'POST',
                			dataType:'text',
                			url:'positionDataAuthority_revoke.action',
                			data:'position_id='+position_id+'&systemModuleId='+systemModuleId+'&dataAuthoritys_id='+dataAuthoritys_id+'&random='+JM.randomNumber,
                			success:function(data){
                				//alert('no');
                			}
		...
		<div class="site_warp">
			...
			<div class="site_right">
				...
				<div id="viewbox" class="site_right_box">
					<input type="hidden" id="postion_id" name="postion_id" value="${id }"/>
					<table class="my_table100_tree margin_top10">
						<tr>
							<td>
								<ticket:systemCommon type="positionObj" value="${id }"/>
							给${positionObj.name }授数据权限</td></td>
						</tr>
