					...
					<form action="/${actionName}_edit.action" id="commonForm" name="commonForm">
						...
						<table class="my_table100 margin_top10">
							<tr>
								...
								<td>
									<select id="trafficType_id" name="trafficType_id" class="my_input" datatype="*">
										<option value="${trafficLine.trafficType_id }">
							...
							<tr>
								...
								<td>
									<input id="startStation" name="startStation" class="my_input" datatype="*"
									       value="${trafficLine.startStation}"/>
							...
							<tr>
								...
								<td>
									<input id="startTime" onclick="new WdatePicker({dateFmt:'HH:mm'});" name="startTime" class="my_input" datatype="*"
									       value="<s:date name="trafficLine.startTime" format="HH:mm"/>"/>
							...
							<tr>
								...
								<td>
									<input id="endTime" onclick="new WdatePicker({dateFmt:'HH:mm'});" name="endTime" class="my_input" datatype="*"
									       value="<s:date name="trafficLine.endTime" format="HH:mm"/>"/>
							...
							<tr>
								...
								<td>
									<input id="departureRate" name="departureRate" class="my_input" ignore="ignore"
									       value="${trafficLine.departureRate}"/>
							...
							<tr>
								...
								<td>
									<textarea id="remark" name="remark" class="my_input" ignore="ignore">
										${trafficLine.remark}
									</textarea>
							...
							<tr>
								...
								<td>
									<input id="orderValue" name="orderValue" value="${trafficLine.status.orderValue }" class="my_input" ignore="ignore"/>
