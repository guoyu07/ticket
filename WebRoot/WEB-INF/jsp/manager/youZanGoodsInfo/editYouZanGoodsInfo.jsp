									...
									<tr>
										...
										<td>
											<input id="detail_url" name="detail_url" class="my_input" datatype="*"
											       value="${youZanGoodsInfo.detail_url}"/>
									...
									<tr>
										...
										<td>
											<input id="sold_num" name="sold_num" class="my_input" datatype="*"
											       value="${youZanGoodsInfo.sold_num}"/>
