					...
					<form action="/${actionName}_add.action" id="commonForm" name="commonForm">
						...
						<table class="my_table100 margin_top10">
							...
							<tr>
								...
								<td>
									<input id="icon" name="icon" class="my_input" datatype="s1-30" value="default.png"/>
									<p class="Validform_checktip" style="display:inline;"> 请选择模块图标</p>
								</td>
							</tr>
							<tr>
								<td class="text_align_right" width="150">
								...
								<td>
									<input id="orderValue" name="orderValue" class="my_input" datatype="n1-10" value="1"/>
