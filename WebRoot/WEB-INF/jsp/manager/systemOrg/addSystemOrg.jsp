		...
		<div class="site_warp">
			...
			<div class="site_right">
				...
				<div id="viewbox" class="site_right_box">
					...
					<form method="post" action="/${actionName}_add.action" id="commonForm" name="org.commonForm">
						...
						<table class="my_table100 margin_top10">
							...
							<tr>
								...
								<td>
									<input name="org.status.orderValue" class="my_input" datatype="n" value="0" ignore="ignore"/>
							...
							<tr>
								...
								<td>
									<textarea name="org.description" class="my_input"></textarea>
									<p class="Validform_checktip" style="display:inline;"> 请填写机构值</p>
								</td>
							</tr>
						</table>
