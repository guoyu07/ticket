		...
		<div class="site_warp">
			...
			<div class="site_right">
				...
				<div id="viewbox" class="site_right_box">
					...
					<form action="/${actionName}_changeState.action" id="commonForm" name="commonForm">
						...
						<table class="my_table100 margin_top10">
									...
									<tr>
										...
										<td>
											<select name="state" id="state" class="my_input">
												<option <s:if test="hitSingleLog.state == 0">selected</s:if> value="0">未审批</option>
												<option <s:if test="hitSingleLog.state == 1">selected</s:if> value="1">通过</option>
												<option <s:if test="hitSingleLog.state == 2">selected</s:if> value="2">未通过</option>
											</select>
										</td>
									</tr>
									<tr>
										...
										<td>
											<textarea id="remark" name="remark" class="my_input"  style="width: 19%;height: 100px;">
												${hitSingleLog.remark}
											</textarea>
										</td>
									</tr>
