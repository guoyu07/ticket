								  ...
								  <s:if test="pageModule != null && pageModule.totalCount > 0">
								  	<s:iterator id="c" value="pageModule.pageList" status="st">
								  		<tr>
										    ...
										    <td>${c.businessInfo.name }</td>
										    <td>${c.businessEvent.name }</td>
										    <td>
										    	<ticket:common type="businessEventExpiry" value="${c.businessEvent.id }"/>
										    	<s:if test="#request.businessEventExpiry == 1 && #c.businessEvent.freezeStatus != @com.ticket.enumer.FreezeStatus@freeze">有效</s:if>
										    	<s:elseif test="#request.businessEventExpiry == 2 && #c.businessEvent.freezeStatus != @com.ticket.enumer.FreezeStatus@freeze">有效</s:elseif>
										    	<s:elseif test="#request.businessEventExpiry == 3 || #c.businessEvent.freezeStatus == @com.ticket.enumer.FreezeStatus@freeze">无效</s:elseif>
										    </td>
										    <td><span>
