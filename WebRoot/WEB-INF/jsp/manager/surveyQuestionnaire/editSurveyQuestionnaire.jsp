					...
					<form action="/${actionName}_edit.action" id="commonForm" name="commonForm">
						...
						<table class="my_table100 margin_top10">
							<tr>
								...
								<td>
									<input id="title" name="title" class="my_input" datatype="*"
									       value="${surveyQuestionnaire.title}"/>
							...
							<tr>
								...
								<td>
									<input id="descript" name="descript" class="my_input" datatype="*"
									       value="${surveyQuestionnaire.descript}"/>
								...
								<td>
									...
									<s:if test="#request.survryModularList != null">
										<s:iterator id="survryModular" value="#request.survryModularList">
											...
											<s:if test="#survryModular.id == surveyQuestionnaire.survryModularId">
												<option selected="selected" value="${survryModular.id }">${survryModular.name }</option>
											</s:if>
											<s:else>
							...
							<tr>
								...
								<td>
									<input id="deadLine" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});" name="deadLine" value="${surveyQuestionnaire.deadLine }" class="my_input" datatype="*"/>
