					...
					<table class="my_table100 margin_top10">
					    ...
					    <tr style="text-align: center"><td colspan="10">
							<form action="${actionName }_manage.action?versionFlag=site" method="post">
							  	日期:<input id="date" name="date" type="text" onclick="new WdatePicker();"/>
					    ...
					    <tr  class="text_align_left">
					      <td><span>
					      	...
					      	<a href="/timeSearch_manageNoDate.action?versionFlag=site">无结果搜索关键词</a>
					      ...
					      <td>
								<table class="my_table100">
								  <tr class="my_table_top1">
								    ...
								    <td width="20"class="text_align_center">操作</td>
								  </tr>
