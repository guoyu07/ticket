									...
									<tr>
										...
										<td>
											<input id="record_id" name="record_id" class="my_input" datatype="*"
											       value="${auditVisitRecord.record_id}"/>
									...
									<tr>
										...
										<td>
											<input id="employee_id" name="employee_id" class="my_input" datatype="*"
											       value="${auditVisitRecord.employee_id}"/>
											<p class="Validform_checktip" style="display:inline;"> 请填写审核员工id</p>       
										</td>
									</tr>
									<tr>
										<td class="text_align_right" width="150">
