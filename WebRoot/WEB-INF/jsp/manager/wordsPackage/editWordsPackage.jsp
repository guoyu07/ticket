					...
					<form action="/${actionName}_edit.action" id="commonForm" name="commonForm">
						...
						<table class="my_table100 margin_top10">
									<tr>
										...
										<td>
											<textarea id="keywords" name="keywords" class="my_input" datatype="*" style="width:95%; height: 150px;">${wordsPackage.keywords}</textarea>
						...
						<div class="my_table_list_r">
						    ...
						    <a id="manageLink" href="/${actionName}_edit.action?versionFlag=${versionFlag}"></a>
						</div>
					</form>
				</div>
			</div>
