					...
					<form action="/${actionName}_edit.action" id="commonForm" name="commonForm">
						...
						<table class="my_table100 margin_top10">
									<tr>
										...
										<td>
											<input id="favouredPolicyNo" name="favouredPolicyNo" class="my_input" datatype="*"
											       value="${favouredPolicy.favouredPolicyNo}"/>
									...
									<tr>
										...
										<td>
											<input id="rechargeAmount" name="rechargeAmount" class="my_input" 
											       value="${favouredPolicy.rechargeAmount}"/>
									...
									<tr>
										...
										<td>
											<input id="discountRate" name="discountRate" class="my_input" 
											       value="${favouredPolicy.discountRate}"/>
											<p class="Validform_checktip" style="display:inline;">充值比率</p>       
										</td>
									</tr>
									<tr>
										<td class="text_align_right" width="150">
										...
										<td id="sumMoney">
											${favouredPolicy.rechargeAmount*favouredPolicy.discountRate}
										</td>
									</tr>
									<tr>
										<td class="text_align_right" width="150">
										...
										<td>
											...
											<s:if test="#request.channelTypeList != null">
												<s:iterator id="channelType" value="#request.channelTypeList">
													...
													<option <s:if test="#channelType.id == favouredPolicy.discountWay">selected</s:if> value="${channelType.id }">${channelType.name }</option>
												
												</s:iterator>
												</s:if>
											</select>
										
											<p class="Validform_checktip" style="display:inline;"> 请填写渠道类型</p>       
										</td>
									</tr>
									<tr style="display:none;">
										...
										<td>
											<select  id="grade" name="grade">
												...
												<option <s:if test="1 == favouredPolicy.grade">selected</s:if> value="1">一级</option>
												<option <s:if test="2 == favouredPolicy.grade">selected</s:if> value="2">二级</option>
												<option <s:if test="3 == favouredPolicy.grade">selected</s:if> value="3">三级</option>
											</select>
