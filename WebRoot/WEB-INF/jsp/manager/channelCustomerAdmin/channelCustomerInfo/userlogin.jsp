...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body  style=" background:url(/manager/images/loginbg2.jpg)center no-repeat;background-size: cover;" >
		<form action="/channelCustomerAdmin_login.action" id="commonForm" name="commonForm" alertConfirm="false">
			...
			<div class="login_warp">
				<div class="login_box">
					<div class="login_bg">
						<div class="login">
							<li>
								<input type="text" name="loginId" id="username" class="login_input_ico1" datatype="*2-18" placeholder="请输入登录名"/>
