					...
					<form action="/${actionName}_add.action" id="commonForm" name="commonForm">
						...
						<table class="my_table100 margin_top10">
							<tr>
								...
								<td>
									<input name="title" id="title" class="my_input" datatype="*"/>
							...
							<tr>
								...
								<td>
									<textarea id="content" name="content" class="my_input" datatype="*" style="width: 480px;height: 280px">
							...
							<tr>
								...
								<td>
									<input id="url" name="url" class="my_input" style="width: 360px" datatype="*" ignore="ignore"/>
