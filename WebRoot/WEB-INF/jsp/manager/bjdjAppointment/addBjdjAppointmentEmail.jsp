		...
		<div class="site_warp">
			...
			<div class="site_right">
				...
				<div id="viewbox" class="site_right_box">
					...
					<form action="/${actionName}_addForEmail.action" id="commonForm" name="commonForm">
						...
						<table class="my_table100 margin_top10">
									...
									<tr>
										...
										<td>
											<input id="mobile" name="mobile" class="my_input" datatype="m"/>
											<p class="Validform_checktip" style="display:inline;"> 请填写电话号码</p>
										</td>
									</tr>
									<tr>
										...
										<td>
											<input id="email" name="email" class="my_input" datatype="/^(\w)+(\.\w+)*@(\w)+((\.\w+)+)$/"/>
											<p class="Validform_checktip" style="display:inline;"> 请填写电子邮箱</p>
										</td>
									</tr>
									<tr>
										<td class="text_align_right" width="150">
						...
						<div class="my_table_list_r">
						    ...
						    <a id="addLink" href="/${actionName}_addForEmail.action"></a>
