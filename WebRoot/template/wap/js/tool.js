...
* @Last Modified time: 2015-12-26 22:49:30
*/
var cfg={};
    cfg.scale = 1;
    cfg.zoom = 1;//默认缩放比
...
;(function($,window,document,undefined){
    ...
    $.do_dialog={
        ...
        init : function(config){
            ...
            //设置模板
            _this.opts[_index].html = $("<div class='do_dialog' id='do_dialog_"+_index+"' style='position:fixed;top:0px;right:0px;bottom:0px;left:0px;width:100%;height:100%;overflow:hidden;z-index:"+(_this.opts[_index].zIndex+_index)+";-webkit-transform:all ease 0.2s;-moz-transform:all ease 0.2s;transform:all ease 0.2s'></div>");
        ...
        show : function(){
            ...
            if(_this.opts[_index].maskClick){
                setTimeout(function(){
                    _this.opts[_index].mask.on('tap',function(){
                        _this.close($(this).parent().data('id'));
                    });
                }, 500)

                //阻止底层滚地
                _this.opts[_index].mask.on('scrollstart',function(e){
                    e.preventDefault();
                });
            }
    ...
    $.fn.animateObj=function(anim,cb){
